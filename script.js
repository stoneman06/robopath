...
for (let i = 0; i < xxxx.length; i = i + 1)
    xxxx[i].addEventListener('click', () => {
        ...
        updateStartBtnText();
        updatebackground();
        xxxx[i].style.backgroundColor = '#ffc107';
...
for (let i = 0; i < xxxx.length; i = i + 1)
        ...
        xxxx[i].style.backgroundColor = 'transparent';
        // xxxx[i].style.color = 'white';
        console.log("Algorithm has been changd to: " + algorithm);
    
    // document.getElementsByClassName('dropdown-item').style.backgroundColor = 'white' ;
    return;
}
